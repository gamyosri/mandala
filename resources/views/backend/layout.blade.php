...
<div>
    <div class="md:flex flex-col md:flex-row md:min-h-screen w-full bg-gray-300 shadow-2xl">
        <div @click.away="open = false"
            ...
            <div class="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
                <a href="#"
                   class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline ">Mandala</a>
