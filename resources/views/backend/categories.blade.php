    ...
    <div class="flex flex-col w-1/2 mx-auto">
        ...
        <div class=" m-5 shadow-2xl">
            <table class=" p-3 w-full">
                ...
                <th class="p-3 text-left" id="name">Affiche</th>
                ...
                <tr class="">
                    ...
                    <td class="p-3 text-left"><span class="{{$category['status'] == 'active'? 'bg-green-200' : 'bg-red-200' }} text-green-600 py-1 px-3 rounded-full text-xs">view</span></td>
