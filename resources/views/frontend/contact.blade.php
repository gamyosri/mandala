...
<div class="bg-blue-300 flex flex-wrap justify-center">
    <form class=" bg-green-200 p-5 flex flex-wrap flex-col justify-center my-20 rounded-2xl shadow-xl">
        ...
        <div class="flex flex-row flex-wrap justify-center">
                <button class=" w-1/2 bg-pink-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                    Envoyer
                </button>
        </div>
    </form>
