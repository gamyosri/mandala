...
@section('content')
    <div id="categories" class="bg-gray-100 border-b-2 border-black">
        <ul class=" flex :flex-row flex-wrap md:flex-nowrap md:py-3 justify-center">
            <li class="mx-5 my-3"><a class="p-4 hover:bg-pink-300 rounded-lg transition ease-in-out duration-700"
                                     href="#">categorie</a>
            </li>
            <li class="mx-5 my-3"><a class="p-4 hover:bg-pink-300 rounded-lg transition ease-in-out duration-700"
                                     href="#">categorie</a>
    ...
    <div class="bg-blue-200 flex flex-col justify-between content-center">
